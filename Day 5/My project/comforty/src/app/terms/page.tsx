        ...
        <div className="container mx-auto px-6">
          ...
          <div className="space-y-8">
            ...
            <p className="text-gray-600">
              Welcome to Comforty. By using our website, you agree to the
              following terms and conditions. Please read them carefully. If you
              do not agree with any part of these terms, you must not use this
              website.
            </p>
      ...
      <footer className="bg-gray-100 py-4">
        <div className="container mx-auto px-6 text-center">
          <p className="text-sm text-gray-600">
            These terms and conditions were last updated on December 23, 2024.
